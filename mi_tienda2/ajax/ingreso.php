...
// Verificar si no se ha iniciado la sesión y comenzarla si es necesario
...
// Obtener los datos del formulario o establecer valores predeterminados
...
switch ($_GET["op"]) {
    case 'guardaryeditar':
		// Verificar si el idingreso está vacío (insertar) o no (editar)
		if (empty($idingreso)) {
			// Insertar ingreso
