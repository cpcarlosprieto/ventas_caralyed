...
class Persona {
    ...
    // Método para insertar un registro de persona
    ...
    // Método para editar un registro de persona
    ...
    // Función para eliminar datos de una persona
    ...
    // Método para listar registros de proveedores
    public function listarp() {
        $sql = "SELECT * FROM persona WHERE tipo_persona='Proveedor'";
        return ejecutarConsulta($sql);
    }

    // Método para listar registros de clientes
