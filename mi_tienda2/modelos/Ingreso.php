...
class Ingreso {
    ...
    // Método para insertar un registro de ingreso
    public function insertar($idproveedor, $idusuario, $tipo_comprobante, $serie_comprobante, $num_comprobante, $fecha_hora, $impuesto, $total_compra, $idarticulo, $cantidad, $precio_compra, $precio_venta) {
        ...
        // Insertar detalles del ingreso en la tabla detalle_ingreso
    ...
    // Método para anular un ingreso
    public function anular($idingreso) {
        $sql = "UPDATE ingreso SET estado='Anulado' WHERE idingreso='$idingreso'";
        return ejecutarConsulta($sql);
    }

    // Método para mostrar los datos de un ingreso
    ...
    // Método para listar los detalles de un ingreso
